...
<html lang="ckb" dir="rtl">
    <head>
        ...
        <style>
         ...
         @font-face{font-family:'kurd';font-style:normal;font-weight:400;src:url('/style/font/DroidNaskh-Regular.woff2') format('woff2');font-display:swap;}
	...
	<div style="flex: 1 0 auto;">
        ...
        <script>
         ...
         function search() {
	     search_wikipedia ( q.value, "#res_wikipedia" );
